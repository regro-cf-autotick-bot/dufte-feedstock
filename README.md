...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dufte-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13006&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dufte-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dufte` can be installed with:

```
conda install dufte
```

It is possible to list all of the versions of `dufte` available on your platform with:
